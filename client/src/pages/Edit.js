...
import { getKlubovi, getFull, exportCSV, exportJSON, getIgraci, addKlub, deleteKlub } from "../utils/fetch";
...
const Edit = (props) => {
    ...
    return(isAuthenticated && (<>
        ...
        <div class="divform">
            ...
            <div><button onClick={() => deleteKlub(form.idkluba)}>Obriši</button></div>
        </div>
    </>));
};
